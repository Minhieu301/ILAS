...
public interface ArticleRepository extends JpaRepository<Article, Integer> {
    ...
    @Query("SELECT a FROM Article a " +
           "WHERE a.status = 'active' AND a.law.status = 'active' AND a.versionNumber = a.law.versionNumber AND (" +
    ...
    // Tìm articles theo law ID (chỉ khi law.status = 'active')
       @Query("SELECT a FROM Article a WHERE a.law.lawId = :lawId AND a.status = 'active' AND a.law.status = 'active' AND a.versionNumber = a.law.versionNumber")
    ...
    @Query(value = "SELECT a.* FROM articles a " +
           ...
           "WHERE a.law_id = :lawId AND a.status = 'active' AND l.status = 'active' AND a.version_number = l.version_number AND " +
    ...
    // Tìm kiếm articles theo số điều (chỉ khi law.status = 'active')
       @Query("SELECT a FROM Article a WHERE a.articleNumber LIKE CONCAT('%', :articleNumber, '%') AND a.status = 'active' AND a.law.status = 'active' AND a.versionNumber = a.law.versionNumber")
    ...
    // Tìm kiếm articles theo law ID và số điều chính xác (chỉ khi law.status = 'active')
       @Query("SELECT a FROM Article a WHERE a.law.lawId = :lawId AND a.articleNumber = :articleNumber AND a.status = 'active' AND a.law.status = 'active' AND a.versionNumber = a.law.versionNumber")
    ...
    // Tìm kiếm articles theo law ID và số điều (LIKE) (chỉ khi law.status = 'active')
       @Query("SELECT a FROM Article a WHERE a.law.lawId = :lawId AND a.articleNumber LIKE CONCAT('%', :articleNumber, '%') AND a.status = 'active' AND a.law.status = 'active' AND a.versionNumber = a.law.versionNumber")
    ...
    // Tìm kiếm articles theo số điều chính xác (chỉ khi law.status = 'active')
       @Query("SELECT a FROM Article a WHERE a.articleNumber = :articleNumber AND a.status = 'active' AND a.law.status = 'active' AND a.versionNumber = a.law.versionNumber")
    ...
    // Tìm kiếm articles theo chương (chỉ khi law.status = 'active')
       @Query("SELECT a FROM Article a WHERE a.chapter.chapterId = :chapterId AND a.status = 'active' AND a.law.status = 'active' AND a.versionNumber = a.law.versionNumber")
     ...
     */
       @Query("SELECT a FROM Article a WHERE a.status = 'active' AND a.law.status = 'active' AND a.versionNumber = a.law.versionNumber")
    ...
    @Query(value = "SELECT a.* FROM articles a " +
           "INNER JOIN laws l ON a.law_id = l.law_id " +
           "WHERE a.status = 'active' AND l.status = 'active' AND a.version_number = l.version_number AND (" +
           "LOWER(a.article_title) LIKE LOWER(CONCAT('%', :keyword, '%')) OR " +
           "LOWER(a.content) LIKE LOWER(CONCAT('%', :keyword, '%'))) " +
           "ORDER BY " +
